...
public class EditorTexto extends JInternalFrame {
    ...
    private final JComboBox<Integer> comboTamano = new JComboBox<>(
            new Integer[] { 6, 8, 10, 12, 14, 16, 18, 20, 24, 28, 36, 48, 60, 72, 96 });
    ...
    private File carpetaOrigen = null;
